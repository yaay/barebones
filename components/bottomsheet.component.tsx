    ...
    ({ onSubmit }, ref) => {
        ...
        return (
            <ActionSheet
                ...
                gestureEnabled={true}
                keyboardHandlerEnabled={Platform.OS === "ios" ? true : false}
            >
...
export const AddBodyConditionLogSheet = forwardRef<
    ActionSheetRef,
    AddBodyConditionLogProps
>(({ onSubmit }, ref) => {
...
export const AddVetVisitLogSheet = forwardRef<
    ActionSheetRef,
    AddVetVisitLogProps
>(({ onSubmit }, ref) => {
